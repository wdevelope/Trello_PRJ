...
class CommentService {
  async getComment(cardId) {
    const getCommentData = await commentRepository.getComments(cardId);
  ...
  async updateComment(commentId, id, comment) {
    ...
    try {
      ...
      const updatedCommentData = await commentRepository.findCommentById(
        commentId,
      );
  ...
  async deleteComment(commentId, id) {
    ...
    try {
      const deletedCommentData = await commentRepository.findCommentById(
        commentId,
      );
